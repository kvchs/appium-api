/**
 * 先决条件：
计算器应用程序应安装在您的Android设备。

deviceName - 与PC连接的设备的名称。
CapabilityType.VERSION - 您的Android设备的操作系统版本。
appPackage - 计算器应用程序的包名称。
appActivity - 计算器应用的活动名称。
 */
...
public class SimpleAndroidCalcTest {
	...
	public void setUp() throws MalformedURLException {
		...
		capabilities.setCapability("deviceName", "Samsung Galaxy S3");
	...
	public void Sum() {
		...
		driver.findElement(By.xpath("//android.widget.Button[@text='8']"))
				.click();
		;
		...
		driver.findElement(By.xpath("//android.widget.Button[@text='6']"))
				.click();
